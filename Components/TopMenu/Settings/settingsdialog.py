...
class SettingsDialog(Dialog):
    ...
    def initUI(self):
        ...
        self.checkExam.setGeometry(QRect(240, 164, 20, 20))
        ...
        labelExamDataPermit.setGeometry(QRect(30, 161, 195, 22))
        ...
        labelExamYes.setGeometry(QRect(262, 162, 300, 22))
        ...
        labelData.setGeometry(QRect(30, 191, 200, 22))
        ...
        labelDelete.setGeometry(QRect(240, 191, 140, 22))
        ...
        labelDataLocal.setGeometry(QRect(30, 221, 205, 22))
        ...
        labelOpen.setGeometry(QRect(240, 221, 150, 22))
        ...
        okButton.setGeometry(QRect(30, 270, 141, 41))
