...
class UcSpRecentItem(QWidget):
    ...
    def setupUi(self, uc_sp_recentitem):
        ...
        font.setPointSize(self.c.getEditorFontSize()+2)
        font.setBold(True)
        # font.setWeight(55)
        ...
        self.lbl_description.setMaximumWidth(245)
        ...
        self.lbl_date.setMinimumSize(QtCore.QSize(152, 30))
        self.lbl_date.setMaximumSize(QtCore.QSize(152, 16777215))
        font = QtGui.QFont()
        font.setFamily(self.c.getEditorFont())
        font.setPointSize(self.c.getEditorFontSize())
